...
<section>
    <div class="container-fluid">
        @if(in_array("projects-add", $all_permission))
            <a href="{{route('project.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add Projects')}} </a>
        @endif
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default">
                                ...
                                <li>
                                        <a href="{{ route('project.edit', $item->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                    </li>
                                @endif
                                @if(in_array("projects-delete", $all_permission))
                                <li class="divider"></li>

                                    {{ Form::open(['route' => ['project.destroy', $item->id], 'method' => 'DELETE'] ) }}
                                    <li>
...
<script type="text/javascript">
    ...
    $("ul#projects #projects-menu").addClass("active");
