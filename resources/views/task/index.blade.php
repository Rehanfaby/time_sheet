...
<section>
    <div class="container-fluid">
        @if(in_array("task-add", $all_permission))
            <a href="{{route('task.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Create Task')}} </a>
        @endif
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default">
                                ...
                                <li>
                                        <a href="{{ route('task.edit', $item->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                    </li>
                                @endif
                                @if(in_array("task-delete", $all_permission))
                                <li class="divider"></li>

                                    {{ Form::open(['route' => ['task.destroy', $item->id], 'method' => 'DELETE'] ) }}
                                    <li>
